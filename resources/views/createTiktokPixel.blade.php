    ...
    <body class="antialiased">
        <div class="relative min-h-screen bg-gray-100 dark:bg-gray-900 sm:pt-0 flex justify-center items-center pb-10">
            ...
            <div class="sm:px-6 lg:px-8 max-w-4xl mx-auto w-100 flex-none">
                <div class="bg-white lg:px-8 py-8 mt-4 shadow border-black rounded-xl">
                    <h2 class="mt-0 welcome-text text-center color-black">Add Your Tiktok Pixel</h2>
                    <form action="" method="POST">
                        <label>Add Titktok Pixel Script</label>
                        <textarea type="text" class="form-textarea mb-2" name="tiktok_pixel"></textarea>
                        <div class="text-center">
                            <button class="primary-btn tiktok-btn cursor-pointer">Submit</button>
                        </div>
                    </form>
                </div>
            </div>
