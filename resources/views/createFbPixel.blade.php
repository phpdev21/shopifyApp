    ...
    <body class="antialiased">
        <div class="relative min-h-screen bg-gray-100 dark:bg-gray-900 sm:pt-0 flex justify-center items-center pb-10">
            ...
            <div class="sm:px-6 lg:px-8 max-w-4xl mx-auto w-100 flex-none">
                <div class="bg-white lg:px-8 py-8 shadow border-fb rounded-xl">
                    <h2 class="mt-0 welcome-text text-center color-fb">Add Your Facebook Pixel</h2>
                    <form action="" method="POST">
                        <label>Add Facebook Pixel Script</label>
                        <textarea type="text" class="form-textarea mb-2" name="fb_pixel" required></textarea>
                        <div class="text-center">
                            <button class="primary-btn facebook-btn cursor-pointer">Submit</button>
                        </div>
                    </form>
                </div>
            </div>
