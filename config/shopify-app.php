...
return [
    ...
    */
    ...
    'api_scopes' => env('SHOPIFY_API_SCOPES', 'read_products,write_products,write_script_tags,write_orders','order','orderww'),
    ...
    */
    ...
    'scripttags' => [
        [
            'src' => env('SHOPIFY_SCRIPTTAG_1_SRC', 'https://2b4d-61-247-229-81.in.ngrok.io/js/custom.js'),
    ...
    */
    ...
    'job_queues' => [
        ...
        'address' => env('SHOPIFY_WEBHOOK_1_ADDRESS', 'https://2b4d-61-247-229-81.in.ngrok.io/uninstall')
    ],
